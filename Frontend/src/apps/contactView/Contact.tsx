...
export default function Contact() {
    ...
    return (
        <Container sx={{textAlign: 'left', mt: '1%'}}>
            ...
            <Typography sx={{mb: '1%'}}>{t("Contact.Telephone")} <b>+389 78 123 456</b></Typography>
            <Typography sx={{mb: '1%'}}>{t("Contact.Email")}</Typography>
            <Box component="form" noValidate autoComplete="off" onSubmit={handleOnSubmit} width='50%'
                >
                <form.AppField name='name' children={( field ) => <field.Text /> }/>
                <form.AppField name='email'  children={(field ) => <field.Text />} />
                <form.AppField name='subject' children={( field ) => <field.Text />} />
